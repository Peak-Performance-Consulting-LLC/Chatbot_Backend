-- Baseline objects required before the phase migrations can be replayed.
-- Supabase CLI shadow databases start empty, while phase 001 expects these
-- core tables to already exist.
