...
import { runPresenceMaintenanceSweep } from "@/services/presence";
...
/**
 * GET /api/cron/presence-maintenance
 * Run every 30s via scheduler.
 */
export async function GET(request: Request) {
  ...
  try {
    const result = await runPresenceMaintenanceSweep(500);
