...
const envSchema = z.object({
  ...
  AGENT_API_RATE_LIMIT_MAX_REQUESTS: z.coerce.number().int().positive().default(120),
  AGENT_API_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(60000),
  REALTIME_RATE_LIMIT_MAX_EVENTS: z.coerce.number().int().positive().default(240),
  REALTIME_RATE_LIMIT_WINDOW_MS: z.coerce.number().int().positive().default(60000),
  CRON_SECRET: z.string().optional(),
  HANDOFF_ENABLED_TENANTS: z.string().default(""),
  RETENTION_PURGE_ENABLED: booleanEnvSchema.default(false),
